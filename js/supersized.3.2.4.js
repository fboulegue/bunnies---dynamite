...
(function($){
    ...
    $.supersized = function(options){
		...
		base.launch = function(){
			...
			$('#supersized-logoLoader').remove();	//Hide loading logo

			
			//check content initial status
			if(appearOnLoad == 1){
					
		  		    $('#toggleBut').show();
					$('#navArrows, .captionContainer,#s_ind').hide();
					$('#navContainer').stop().animate({left:'0px'},contentToggleSpeed, menuEase);					//toggle menu		
					$('#header #inner').stop().animate({left:'0px'},contentToggleSpeed, menuEase);					//toggle header
					$('#content-wrapper').show().stop().animate({left:'0px'}, contentToggleSpeed,pageEase);			//toggle content
			...
			if(menuAppear==1) $('#navArrows, .captionContainer,#s_ind').hide();
